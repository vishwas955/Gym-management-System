...
exports.disableMembership = async (req,res) => {
    try {
        ...
        const membership = await membership_model.findById({_id})
        .populate("gymMemberId","first_name last_name")
...
exports.getMembership = async (req,res) => {
    try {
        ...
        .find() // Fetch only active Membership 
        .populate("gymMemberId", "first_name last_name email") //Populate User Detail
        .populate("subscriptionId", "name")
