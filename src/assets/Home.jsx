    ...
    <div className="bg-black text-white">
      ...
      >
        <motion.div className="space-y-4" variants={itemVariants}>
          ...
          <p className="text-lg text-gray-300">We got you covered with our Fitness Starter Bundle</p>
          <p className="text-gray-400">First up we take your fitness test, followed by the card planner. Next up we back you with the nutrition.</p>
          <motion.button
